...
- 💻 Я люблю работать с новыми технологиями и языками программирования
- 🎓 Я закончил обучени в академии ТOP <a href="https://github.com/Stervar/Sbornik-3">Тыкай сюда 
- 💻 Я люблю создавать что-то новое и интересное
...
- 📚 Знания по базовым и продвинутым темам (Подробная информация) <a href="https://github.com/Stervar/Sbornik-3">Тыкай сюда
...
- 📟 Оличное знания и понимания терминала 📟 (Пример проекта высшего уровня) <a  href="https://github.com/Stervar/Heart-3D-Terminal">Тыкай сюда
...
> Вот бы поскорее войти в команду и начать создавать и использовать свои возможности по назначению.